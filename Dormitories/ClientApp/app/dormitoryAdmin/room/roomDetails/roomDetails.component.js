...
var RoomDetailsForDormitoryAdministratorComponent = /** @class */ (function () {
    function RoomDetailsForDormitoryAdministratorComponent(router, activateRoute, rs) {
        var _this = this;
        this.router = router;
...
export { RoomDetailsForDormitoryAdministratorComponent };
