...
var StudentCategoriesForAdministratorComponent = /** @class */ (function () {
    function StudentCategoriesForAdministratorComponent(router, activateRoute, rs) {
        var _this = this;
        this.router = router;
    ...
    var _a, _b;
    StudentCategoriesForAdministratorComponent = __decorate([
        Component({
    ...
    ], StudentCategoriesForAdministratorComponent);
    return StudentCategoriesForAdministratorComponent;
}());
export { StudentCategoriesForAdministratorComponent };
