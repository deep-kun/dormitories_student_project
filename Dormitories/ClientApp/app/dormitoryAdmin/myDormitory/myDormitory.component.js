...
var MyDormitoryComponent = /** @class */ (function () {
    function MyDormitoryComponent(router, activateRoute, rs) {
        var _this = this;
        this.router = router;
    ...
    var _a, _b;
    MyDormitoryComponent = __decorate([
        Component({
    ...
    return MyDormitoryComponent;
}());
export { MyDormitoryComponent };
//# sourceMappingURL=myDormitory.component.js.map