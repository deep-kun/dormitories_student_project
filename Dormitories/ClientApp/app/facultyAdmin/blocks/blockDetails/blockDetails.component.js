...
var BlockDetailsForFacultyAdministratorComponent = /** @class */ (function () {
    function BlockDetailsForFacultyAdministratorComponent(router, activateRoute, rs) {
        var _this = this;
        this.router = router;
...
export { BlockDetailsForFacultyAdministratorComponent };
